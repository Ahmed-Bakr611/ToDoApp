    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
        <div class="text-center mb-8">
          <h1 class="text-4xl font-bold bg-linear-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent mb-2">
            Create Account</h1>
        ...
        <form wire:submit="register" class="space-y-5">
          <div>
            ...
            <input wire:model="name" type="text" id="name"
              class="mt-2 w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#667eea] focus:ring-2 focus:ring-[#667eea]/20 transition @error('name') border-red-500 @enderror"
          ...
          <div>
            <label for="password_confirmation" class="block text-sm font-semibold text-gray-800">Confirm
              Password</label>
            <input wire:model="password_confirmation" type="password" id="password_confirmation"
              class="mt-2 w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#667eea] focus:ring-2 focus:ring-[#667eea]/20 transition"
              placeholder="••••••••" />
          </div>

          <button type="submit"
            class="w-full bg-linear-to-r from-[#667eea] to-[#764ba2] text-white font-semibold py-3 rounded-lg hover:shadow-xl transition transform hover:-translate-y-0.5 active:translate-y-0">
            Create Account
          </button>
        </form>
