<div class="max-w-2xl mx-auto px-4 py-8">
  <div class="bg-white border border-gray-300 rounded-lg p-6 shadow-sm">
    <div class="border-b border-gray-300 pb-4 mb-6">
      <h1 class="text-2xl font-semibold text-gray-900">{{ $tag ? 'Edit Tag' : 'Create Tag' }}</h1>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
      ...
      <div>
        ...
        <input type="text" id="name" wire:model="name"
          ...
          placeholder="Enter tag name" required autofocus>
        @error('name')
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
            ...
            <div class="md:col-span-2">
              ...
              <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-semibold ml-2">
                {{ $tag->tasks()->count() }} {{ Str::plural('task', $tag->tasks()->count()) }}
              </span>
            </div>
          </div>
        </div>
